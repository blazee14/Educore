...
const auth_prisma_repository_1 = require("./data/auth.prisma.repository");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: auth_repository_interface_1.AUTH_REPOSITORY,
                useClass: auth_prisma_repository_1.AuthPrismaRepository,
            },
        ],
